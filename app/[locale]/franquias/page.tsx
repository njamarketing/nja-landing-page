...
export async function generateMetadata({
  ...
  const description =
    "Conheça a expansão da NJA pelo Brasil e as oportunidades de franquia.";
...
export default async function FranquiasPage({ params }: PageProps) {
  ...
  const ctaCards = (
    homeT.raw("hero.cards") as { label: string; image: string }[]
  ).slice(0, 3);
    ...
    <>
      ...
      >
          ...
          <SectionReveal className="relative mx-auto max-w-7xl pt-14 md:pt-20">
            <div className="max-w-3xl">
              ...
              <p className="mt-8 max-w-2xl text-base leading-8 text-white/70 md:text-lg">
                A NJA está expandindo sua presença no território brasileiro por
                meio de unidades que levam nossa metodologia, experiência e
                visão estratégica para empresas de diferentes regiões do país.
              </p>
            ...
            <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-2">
              ...
              >
                <p className="text-lg leading-8 text-white/78">
                  Cada nova franquia representa mais do que um novo endereço.
                  Representa a chegada de uma metodologia validada
                  internacionalmente, aplicada por profissionais que conhecem de
                  perto os desafios e as oportunidades do mercado local.
                </p>
                <p className="mt-6 text-lg leading-8 text-white/78">
                  Nosso objetivo é construir uma rede cada vez mais forte,
                  conectando estratégia, conhecimento e execução para ajudar
                  empresas brasileiras a crescerem de forma consistente.
                </p>
              </SectionReveal>
              <SectionReveal
              ...
              >
                ...
                <p className="mt-5 leading-7 text-white/68">
                  Uma expansão construída para gerar impacto real em cada
                  mercado onde a NJA chega.
                </p>
              </SectionReveal>
            </div>
          </section>
          ...
          <section className="relative py-20 pr-4 pl-16 sm:py-24 sm:pr-6 sm:pl-24 md:py-32 md:pr-6 md:pl-6">
            ...
            <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-2">
              <SectionReveal className="flex min-h-72 flex-col justify-end rounded-[2rem] border border-white/10 bg-white/4 p-8 md:p-10">
                ...
                <div className="font-display mt-5 text-6xl text-cyan-200">
                  03
                </div>
              ...
              >
                ...
                <p className="mt-8 max-w-3xl text-base leading-8 text-white/72 md:text-lg">
                  ...
                  , levando nossa metodologia para um dos principais polos
                  econômicos do Paraná e ampliando nossa presença na região Sul
                  do país.
                </p>
                <p className="mt-6 max-w-3xl text-base leading-8 text-white/72 md:text-lg">
                  A nova franquia fará parte de uma rede construída para unir
                  conhecimento global e atuação local, criando novas
                  oportunidades para empresários e empresas da região.
                </p>
        ...
        <LandingCtaSection
          ...
          contactHref={getWhatsAppUrl(homeT("footer.phone"), locale, "franchise")}
          cards={ctaCards}
        />
      </main>
